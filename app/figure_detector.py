...
def fige04_rot1_detector(match: MatchOut, x: int, y: int) -> MatchOut:
    ...
    if (fige04_rot1_verifications(center_x, center_y)):
        ...
        right = (center_x+1, center_y)
        if match_out.board.tiles[coordinates_to_index(up[0], up[1])].tile_color == color and \
        match_out.board.tiles[coordinates_to_index(left[0], left[1])].tile_color == color and \
        match_out.board.tiles[coordinates_to_index(right[0], right[1])].tile_color == color:
            match_out.board.tiles[coordinates_to_index(center_x, center_y)].tile_in_figure = FigType.fige04.value
            match_out.board.tiles[coordinates_to_index(up[0], up[1])].tile_in_figure = FigType.fige04.value
            match_out.board.tiles[coordinates_to_index(left[0], left[1])].tile_in_figure = FigType.fige04.value
            match_out.board.tiles[coordinates_to_index(right[0], right[1])].tile_in_figure = FigType.fige04.value
    return match_out
...
def fige04_rot2_verifications(center_x: int, center_y: int):
    return center_y+1<columns and center_y-1>=0 and center_x-1>=0
...
def fige04_rot3_verifications(center_x: int, center_y: int):
    return center_y+1<columns and center_x+1<columns and center_x-1>=0
...
def fige06_rot1_detector(match: MatchOut, x: int, y: int) -> MatchOut:
    ...
    if (fige06_rot1_verifications(center_x)):
        ...
        if match_out.board.tiles[coordinates_to_index(left[0], left[1])].tile_color == color and \
        match_out.board.tiles[coordinates_to_index(right[0], right[1])].tile_color == color and \
        match_out.board.tiles[coordinates_to_index(right2[0], right2[1])].tile_color == color:
            match_out.board.tiles[coordinates_to_index(center_x, center_y)].tile_in_figure = FigType.fige06.value
            match_out.board.tiles[coordinates_to_index(left[0], left[1])].tile_in_figure = FigType.fige06.value
            match_out.board.tiles[coordinates_to_index(right[0], right[1])].tile_in_figure = FigType.fige06.value
            match_out.board.tiles[coordinates_to_index(right2[0], right2[1])].tile_in_figure = FigType.fige06.value
    return match_out

def fige06_rot1_verifications(center_x: int):
    return center_x-1>=0 and center_x+2<columns
...
def fige06_rot2_verifications(center_y: int):
    return center_y+1<columns and center_y-2>=0
